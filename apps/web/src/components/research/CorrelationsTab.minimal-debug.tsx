...
export function CorrelationsTabMinimalDebug() {
  ...
  const handleSelectInstrument = useCallback((watchlistItem: any) => {
    ...
    try {
      ...
      // MINIMAL INSTRUMENT OBJECT - no complex calculations
  ...
  console.log("Component render - watchlist:", watchlist);
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                <div>
                  <p className="text-sm font-medium">Selected Instruments Count:</p>
                  <p className="text-lg">{selectedInstruments.length}</p>
                </div>
                
                <div>
                  <p className="text-sm font-medium">Watchlist Count:</p>
                  <p className="text-lg">{watchlist.length}</p>
                </div>
                
                <div>
                  <p className="text-sm font-medium">Selected Instruments:</p>
